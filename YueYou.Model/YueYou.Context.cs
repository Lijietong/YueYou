...
namespace YueYou.Model
{
    ...
    public partial class YueYouEntities : DbContext
    {
        ...
        public virtual int proc_delete(Nullable<int> commentid)
        {
            var commentidParameter = commentid.HasValue ?
                new ObjectParameter("commentid", commentid) :
                new ObjectParameter("commentid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("proc_delete", commentidParameter);
        }
    
        public virtual int proc_delete_reply_comment(Nullable<int> commentid)
        {
            var commentidParameter = commentid.HasValue ?
                new ObjectParameter("commentid", commentid) :
                new ObjectParameter("commentid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("proc_delete_reply_comment", commentidParameter);
        }
    }
}
